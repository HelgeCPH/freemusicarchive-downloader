...
from fma_dl.extract_song_metadata import extract_metadata
from fma_dl.extract_urls import extract_urls
from fma_dl.get_pages import get_pages
from fma_dl.url_validation import UrlValidationResult, get_error_message, validate_url
from sys import exit



def main(url, output_dir, silent, meta, prune_no_meta):
...
def cmd_main():
    ...
    main(url, output_dir, silent, meta, prune_no_meta)